...
class GoodsReceiptForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'delivery_charge': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0', 'placeholder': '0.00'}),
            'notes': forms.Textarea(attrs={'class': 'form-control', 'rows': 3}),
        }
        help_texts = {
            ...
            'delivery_charge': 'Delivery/freight charge. Distributed proportionally across items in cost calculation.',
